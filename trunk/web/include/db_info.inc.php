...
static  $OJ_AUTO_SHARE=true; //true: One can view all AC submit if he/she has ACed it once.
...
static  $OJ_KEEP_TIME=3;  //登录Cookie有效时间(单位:天(day),仅在上一行为true时生效)
...
static  $OJ_BEIAN="";  // 如果有备案号，填写备案号,没有填false
