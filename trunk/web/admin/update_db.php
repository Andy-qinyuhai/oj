...
$csql[48]="alter table $DB_NAME.online modify refer varchar(4096) DEFAULT NULL;";
...
$tsql[52]="alter table $DB_NAME.users add column starred int default 0 after activecode ;";
