...
if ($loggedon==$auth_pass){
    ...
    if (isset($_SESSION[$OJ_NAME.'_administrator'])||isset($_SESSION[$OJ_NAME.'_problem_editor']) || isset($_SESSION[$OJ_NAME.'_'."p".$pid])) login();
    else login_form();
}
// +--------------------------------------------------
// | Config Class
...
function dir_list_form() {
	...
	if(isset($_GET['pid'])){
        ...
        $out.="<b></b>
			...
			<b><a href='../admin/fm.php?p=$pid' target='_blank'><font color=red>Tiny File Manager</font></a></b>
