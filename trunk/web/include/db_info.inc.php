...
static  $OJ_MARKDOWN="markdown-it"; // false/marked.js/markdown-it 三选一，开启后在后台编辑题目时默认为源码模式，用[md] # Markdown [/md] 格式插入markdown代码, 如果需要用到[]也可以用<div class='md'> </div>。
