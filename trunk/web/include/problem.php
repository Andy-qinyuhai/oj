<?php
function addproblem($title, $time_limit, $memory_limit, $description, $input, $output, $sample_input, $sample_output,$sample_input_2, $sample_output_2, $hint, $source, $spj, $OJ_DATA) {
  //$spj=($spj);
